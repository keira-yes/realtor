...
const EditApartment = () => {
    ...
    const onSubmit = async (e) => {
        ...
        toast.success('Apartment is edited!');
    ...
    useEffect(() => {
        if (apartment && apartment.userID !== auth.currentUser.uid) {
        ...
        <div className="add-apartment">
            <div className="form-page">
                <div className="form-page__container container">
                    <h1 className="form-page__title">Edit apartment</h1>
                    <main className="form-page__main">
                        <form className="form" name="edit-apartment" onSubmit={onSubmit}>
                            ...
                            <div className="form__submit">
                                <button type="submit" className="form__submit-btn button button--accent">Save changes</button>
                            </div>
                        </form>
                    </main>
                </div>
