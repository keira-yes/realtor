...
const ApartmentPreview = ({ id, data, onDelete }) => {
    const { type, title, images, city, postalCode, bedrooms, floor, houseroom, price, discountPrice } = data;

    return (
        <>
            {onDelete &&
            <button type="button" className="card__delete" onClick={() => onDelete(id)}>
                <svg width="30" height="30" viewBox="0 0 30 30" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <g>
                        <path d="M15.0255 30.0119C11.014 30.0119 7.24021 28.437 4.41731 25.6141C1.59441 22.7912 0.0195312 19.0174 0.0195312 15.0059C0.0195312 10.9945 1.59441 7.22068 4.41731 4.39778C7.24021 1.57488 11.014 0 15.0255 0C19.037 0 22.8107 1.57488 25.6336 4.39778C31.4874 10.2516 31.4874 19.7603 25.6336 25.6141C22.8107 28.437 19.037 30.0119 15.0255 30.0119ZM15.0255 1.78288C11.4894 1.78288 8.16137 3.14976 5.66533 5.6458C3.16929 8.14184 1.80242 11.4699 1.80242 15.0059C1.80242 18.542 3.16929 21.87 5.66533 24.3661C8.16137 26.8621 11.4894 28.229 15.0255 28.229C18.5615 28.229 21.8896 26.8621 24.3856 24.3661C29.556 19.1957 29.556 10.8162 24.3856 5.6458C21.8896 3.14976 18.5615 1.78288 15.0255 1.78288Z" fill="#456078"/>
                        <path d="M22.2978 8.90668L8.93452 22.2697L7.75781 21.093L21.1211 7.72998L22.2978 8.90668Z" fill="#456078"/>
                        <path d="M8.1875 9.33051L9.37609 8.17163L22.302 21.0975L21.1134 22.2861L8.1875 9.33051Z" fill="#456078"/>
                    </g>
                </svg>
            </button>
            }
            <Link to={`/category/${type}/${id}`} className="card">
                ...
                <div className="card__holder">
                    ...
                    <div className="card__city">
                        <svg className="card__city-icon" width="20" height="20" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <ul className="card__options">
                        ...
                        <li className="card__option">
                            ...
                            <strong className="card__option-title">{floor} floor</strong>
                        </li>
                        }
                        {houseroom &&
                        <li className="card__option">
                            <svg className="card__option-icon" width="15" height="15" viewBox="0 0 15 15" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <strong className="card__option-title">{houseroom} м²</strong>
                        </li>
                        }
                    </ul>
                </div>
